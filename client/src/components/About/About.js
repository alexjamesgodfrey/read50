            ...
            <div className="about-meat">
                ...
                <div className="picture-container">
                    ...
                    taking courses is really boring though. so i decided to learn hands on
                        and just experiment. </p>
                    <div>
                        <img className="me" src={me} alt="a picture of me"></img>
                        <p>me (alex)</p>
                    </div>
                </div>
                <p>it took a long time to learn. in fact, i think i could remake this website from scratch in 1/10th the
                ...
                much it <i>sucked</i>. amazon has billions it looks like they don't give 2 sh*ts about goodreads.</span>
                 from that point on in the project i decided to improve upon every one of goodread's features, and add more.
                all with a much more slick user interface. but i haven't been to design school, just a rural high school.
                that's why <span className="special">i want to hear all the feedback you have.</span></p>
                ...
                <p>i believe privacy is a fundamental human right. this website uses three cookies. one for your unique id assigned to you
                when you signed up, your entered username, and your uploaded picture (or default). we only use these cookies to load you profile
                faster. the browser will also remember only your most recent search for ease of use. your most recent search is deleted after you close the window.
                we keep a log of every book you have in your list. we <i>do not</i> track your searches (besides most recent), deleted books, or any other input/clicks.</p>
